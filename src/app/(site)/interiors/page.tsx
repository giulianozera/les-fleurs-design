    ...
    <div className="bg-ivory">
      ...
      <section className="pt-[72px] bg-charcoal text-ivory">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 lg:px-16 py-28 md:py-40">
          ...
          <p className="font-body text-sm text-ivory/50 leading-[1.9] mt-10 max-w-[44ch]">
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 lg:px-16 py-24 md:py-32">
        <div className="max-w-2xl">
          <p className="label-caps text-warm-gray mb-6">Every Space Is Different</p>
          ...
          <p className="font-body text-sm text-warm-gray leading-[2] mb-10 max-w-[52ch]">
